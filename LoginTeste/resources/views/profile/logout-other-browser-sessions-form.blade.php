<?php $contagemPC = count($this->sessions); ?>
<div class="card-config">
    <div class="context-device">
        <img src="{{ asset('imgs/svg/laptop.svg') }}" alt="" class="image" style="border-radius: 0">
        <p class="context">{{ $contagemPC }} sessoões em computadores</p>
    </div>

    <div class="card-devices">
        @if (count($this->sessions) > 0)
            <div class="card-content-plataform">

                @foreach ($this->sessions as $session)
                    @if ($session->is_current_device)
                        <div class="card-plataform active">
                        @else
                            <div class="card-plataform">
                    @endif
                    ...
                    <div class="">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                @else
                                    <p>Outro Dispositivo</p> {{ $session->last_active }}
                                @endif
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-buttom">
        <x-button style="margin-top: 10px;" id="btnLogoutSession">
            {{ __('Desconectar todos os dispositivos') }}
        </x-button>
